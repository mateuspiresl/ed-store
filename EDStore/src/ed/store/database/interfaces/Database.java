...
public interface Database {
	...
	public <T extends Serializable> Struct create(Structures struct, String name, T[] type) throws InvalidNameException, NoPermissionException, UnknownTypeException;
